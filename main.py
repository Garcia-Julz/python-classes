...
#     f_name = " ".join(f_name[i:i+1] for i in range(0, len(f_name)))
#     l_name = " ".join(l_name[i:i+1] for i in range(0, len(l_name)))
#     rev_f_name = f_name[::-1]
#     rev_l_name = l_name[::-1]
#     return print(f'{rev_l_name}  {rev_f_name}')

# reverse_name('Julian', 'Garcia')

# ********** SOLUTION 2 **********

# def last_first(first ,last):
#     result = print(f'{last} {first}')
#     return result

# last_first('julian', 'Garcia')
...
# def foo(sample_data):
#     Tuple = tuple(sample_data)
#     List = list(sample_data)
#     return print(List , Tuple)
...
# filename = "Input the Filename: abc.java"
# x = filename.split('.')
# print("The extension of the file is : " +str(x[-1]))
...
# def foo(color_list):
#     results = color_list[0], color_list[-1]
...
# def exam_dates(x3):
#     converted_date = str(exam_st_date)
#     x1 = converted_date.replace(')', '')
#     x2 = x1.replace('(', '')
#     x3 = x2.replace(',', ' /')
#     results = print(f'The examination will start from : {x3}')
#     return results

# exam_dates(exam_st_date)
...
# Expected Result :
# abs(number) -> number
# Return the absoluhhte value of the argument.

# ********** SOLUTION **********

# def docs(n):
#     results = print(n.__doc__)
#     return results
